  ...
  public static class UserWebServiceClient
  {
      ...
      Action<Exception> handler)
    {
      using (MemoryStream memoryStream = new MemoryStream())
      {
        ...
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IUserWebServiceContract", "UserWebService", nameof (SetLoadout), memoryStream.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
          callback(EnumProxy<MemberOperationResult>.Deserialize((Stream) new MemoryStream(data)));
      ...
      Action<Exception> handler)
    {
      using (MemoryStream memoryStream = new MemoryStream())
      {
        ...
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IUserWebServiceContract", "UserWebService", nameof (SetScore), memoryStream.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
          callback();
    ...
    {
      using (MemoryStream memoryStream = new MemoryStream())
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IUserWebServiceContract", "UserWebService", nameof (GetXPEventsView), memoryStream.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
    ...
    {
      using (MemoryStream memoryStream = new MemoryStream())
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IUserWebServiceContract", "UserWebService", nameof (GetLevelCapsView), memoryStream.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
