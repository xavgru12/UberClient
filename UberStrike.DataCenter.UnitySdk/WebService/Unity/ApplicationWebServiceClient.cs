  ...
  public static class ApplicationWebServiceClient
  {
      ...
      Action<Exception> handler)
    {
      using (MemoryStream memoryStream = new MemoryStream())
      {
        ...
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IApplicationWebServiceContract", "ApplicationWebService", nameof (GetPhotonServers), memoryStream.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
    ...
    {
      using (MemoryStream memoryStream = new MemoryStream())
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IApplicationWebServiceContract", "ApplicationWebService", nameof (GetMyIP), memoryStream.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
      ...
      Action<Exception> handler)
    {
      using (MemoryStream bytes = new MemoryStream())
      {
        ...
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IApplicationWebServiceContract", "ApplicationWebService", nameof (RecordException), bytes.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
          callback();
      ...
      Action<Exception> handler)
    {
      using (MemoryStream bytes = new MemoryStream())
      {
        ...
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IApplicationWebServiceContract", "ApplicationWebService", nameof (RecordExceptionUnencrypted), bytes.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
          callback();
      ...
      Action<Exception> handler)
    {
      using (MemoryStream bytes = new MemoryStream())
      {
        ...
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IApplicationWebServiceContract", "ApplicationWebService", nameof (RecordTutorialStep), bytes.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
          callback();
      ...
      Action<Exception> handler)
    {
      using (MemoryStream memoryStream = new MemoryStream())
      {
        ...
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IApplicationWebServiceContract", "ApplicationWebService", nameof (ReportBug), memoryStream.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
    ...
    {
      using (MemoryStream memoryStream = new MemoryStream())
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IApplicationWebServiceContract", "ApplicationWebService", nameof (GetLiveFeed), memoryStream.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
      ...
      Action<Exception> handler)
    {
      using (MemoryStream bytes = new MemoryStream())
      {
        StringProxy.Serialize((Stream) bytes, appVersion);
        EnumProxy<DefinitionType>.Serialize((Stream) bytes, definition);
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IApplicationWebServiceContract", "ApplicationWebService", nameof (GetItemAssetBundles), bytes.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
      ...
      Action<Exception> handler)
    {
      using (MemoryStream bytes = new MemoryStream())
      {
        ...
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IApplicationWebServiceContract", "ApplicationWebService", nameof (SetLevelVersion), bytes.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
          callback();
      ...
      Action<Exception> handler)
    {
      using (MemoryStream bytes = new MemoryStream())
      {
        ...
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IApplicationWebServiceContract", "ApplicationWebService", nameof (GetPhotonServerName), bytes.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
          callback(StringProxy.Deserialize((Stream) new MemoryStream(data)));
    ...
    {
      using (MemoryStream memoryStream = new MemoryStream())
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IApplicationWebServiceContract", "ApplicationWebService", nameof (IsAlive), memoryStream.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
          callback(StringProxy.Deserialize((Stream) new MemoryStream(data)));
