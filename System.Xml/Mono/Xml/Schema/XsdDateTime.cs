...
// Type: Mono.Xml.Schema.XsdDateTime
...
namespace Mono.Xml.Schema
{
  ...
  {
    internal XsdDateTime() => this.WhitespaceValue = XsdWhitespaceFacet.Collapse;
    ...
    internal override System.ValueType ParseValueType(
      ...
      IXmlNamespaceResolver nsmgr)
    {
      return (System.ValueType) XmlConvert.ToDateTime(this.Normalize(s));
    }
