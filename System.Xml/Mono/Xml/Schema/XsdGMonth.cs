...
// Type: Mono.Xml.Schema.XsdGMonth
...
namespace Mono.Xml.Schema
{
  ...
  {
    internal XsdGMonth() => this.WhitespaceValue = XsdWhitespaceFacet.Collapse;
    ...
    internal override System.ValueType ParseValueType(
      ...
      IXmlNamespaceResolver nsmgr)
    {
      return (System.ValueType) DateTime.ParseExact(this.Normalize(s), "--MM--", (IFormatProvider) null);
    }
