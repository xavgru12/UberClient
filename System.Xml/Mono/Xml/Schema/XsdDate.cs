...
namespace Mono.Xml.Schema
{
  ...
  {
    internal XsdDate() => this.WhitespaceValue = XsdWhitespaceFacet.Collapse;
    ...
    internal override System.ValueType ParseValueType(
      ...
      IXmlNamespaceResolver nsmgr)
    {
      return (System.ValueType) DateTime.ParseExact(this.Normalize(s), "yyyy-MM-dd", (IFormatProvider) null);
    }
