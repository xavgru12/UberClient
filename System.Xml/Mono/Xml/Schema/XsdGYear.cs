...
namespace Mono.Xml.Schema
{
  ...
  {
    internal XsdGYear() => this.WhitespaceValue = XsdWhitespaceFacet.Collapse;
    ...
    internal override System.ValueType ParseValueType(
      ...
      IXmlNamespaceResolver nsmgr)
    {
      return (System.ValueType) DateTime.ParseExact(this.Normalize(s), "yyyy", (IFormatProvider) null);
    }
