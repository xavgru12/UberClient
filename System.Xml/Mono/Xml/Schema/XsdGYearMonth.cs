...
// Type: Mono.Xml.Schema.XsdGYearMonth
...
namespace Mono.Xml.Schema
{
  ...
  {
    internal XsdGYearMonth() => this.WhitespaceValue = XsdWhitespaceFacet.Collapse;
    ...
    internal override System.ValueType ParseValueType(
      ...
      IXmlNamespaceResolver nsmgr)
    {
      return (System.ValueType) DateTime.ParseExact(this.Normalize(s), "yyyy-MM", (IFormatProvider) null);
    }
