...
// Type: Mono.Xml.Schema.XsdGMonthDay
...
namespace Mono.Xml.Schema
{
  ...
  {
    internal XsdGMonthDay() => this.WhitespaceValue = XsdWhitespaceFacet.Collapse;
    ...
    internal override System.ValueType ParseValueType(
      ...
      IXmlNamespaceResolver nsmgr)
    {
      return (System.ValueType) DateTime.ParseExact(this.Normalize(s), "--MM-dd", (IFormatProvider) null);
    }
