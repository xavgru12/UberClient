...
namespace Mono.Xml.Schema
{
  internal class XsdShort : XsdInt
  {
    ...
    internal override System.ValueType ParseValueType(
      ...
      IXmlNamespaceResolver nsmgr)
    {
      return (System.ValueType) XmlConvert.ToInt16(this.Normalize(s));
    }

    internal override XsdOrdering Compare(object x, object y)
    {
      if (!(x is short) || !(y is short num))
        return XsdOrdering.Indeterminate;
      if ((int) (short) x == (int) num)
        return XsdOrdering.Equal;
      return (int) (short) x < (int) (short) y ? XsdOrdering.LessThan : XsdOrdering.GreaterThan;
    }
  }
}
