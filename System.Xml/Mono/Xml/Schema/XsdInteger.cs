...
// Type: Mono.Xml.Schema.XsdInteger
...
namespace Mono.Xml.Schema
{
  internal class XsdInteger : XsdDecimal
  {
    ...
    internal override System.ValueType ParseValueType(
      ...
      IXmlNamespaceResolver nsmgr)
    {
      Decimal d = XmlConvert.ToDecimal(this.Normalize(s));
      return !(Decimal.Floor(d) != d) ? (System.ValueType) d : throw new FormatException("Integer contains point number.");
    }
  }
}
