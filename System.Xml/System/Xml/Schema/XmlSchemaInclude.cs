...
namespace System.Xml.Schema
{
  public class XmlSchemaInclude : XmlSchemaExternal
  {
    ...
    {
      XmlSchemaInclude xso = new XmlSchemaInclude();
      ...
      while (reader.MoveToNextAttribute())
      {
        if (reader.Name == "id")
          ...
          XmlSchemaObject.error(h, reader.Name + " is not a valid attribute for include", (Exception) null);
        else
      ...
      while (reader.ReadNextElement())
      {
        if (reader.NodeType == XmlNodeType.EndElement)
        {
          ...
          {
            XmlSchemaObject.error(h, "Should not happen :2: XmlSchemaInclude.Read, name=" + reader.Name, (Exception) null);
            break;
          }
          break;
        }
