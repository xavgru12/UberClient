...
namespace System.Xml.Schema
{
  public class XmlSchemaComplexContentExtension : XmlSchemaContent
  {
      ...
      foreach (XmlSchemaObject attribute in this.Attributes)
      {
        switch (attribute)
        {
          ...
          case XmlSchemaAttributeGroupRef _:
            ...
            continue;
          default:
            this.error(h, attribute.GetType().ToString() + " is not valid in this place::ComplexConetnetExtension");
            continue;
        }
      }
      if (this.Particle != null)
    ...
    internal override int Validate(ValidationEventHandler h, XmlSchema schema)
    {
      ...
      foreach (XmlSchemaObject attribute in this.Attributes)
        this.errorCount += attribute.Validate(h, schema);
      if (this.Particle != null)
    ...
    internal static XmlSchemaComplexContentExtension Read(
      XmlSchemaReader reader,
      ValidationEventHandler h)
    {
      XmlSchemaComplexContentExtension xso = new XmlSchemaComplexContentExtension();
      reader.MoveToElement();
      if (reader.NamespaceURI != "http://www.w3.org/2001/XMLSchema" || reader.LocalName != "extension")
      {
        XmlSchemaObject.error(h, "Should not happen :1: XmlSchemaComplexContentExtension.Read, name=" + reader.Name, (Exception) null);
        reader.Skip();
        return (XmlSchemaComplexContentExtension) null;
      }
      ...
      while (reader.MoveToNextAttribute())
      {
        if (reader.Name == "base")
        {
          ...
          XmlSchemaObject.error(h, reader.Name + " is not a valid attribute for extension", (Exception) null);
        else
      ...
      while (reader.ReadNextElement())
      {
        if (reader.NodeType == XmlNodeType.EndElement)
        {
          ...
          {
            XmlSchemaObject.error(h, "Should not happen :2: XmlSchemaComplexContentExtension.Read, name=" + reader.Name, (Exception) null);
            break;
          }
          break;
        }
