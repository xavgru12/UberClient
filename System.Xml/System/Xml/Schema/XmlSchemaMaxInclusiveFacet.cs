...
namespace System.Xml.Schema
{
  public class XmlSchemaMaxInclusiveFacet : XmlSchemaFacet
  {
    ...
    internal override XmlSchemaFacet.Facet ThisFacet => XmlSchemaFacet.Facet.maxInclusive;

    internal static XmlSchemaMaxInclusiveFacet Read(
      XmlSchemaReader reader,
      ValidationEventHandler h)
    {
      XmlSchemaMaxInclusiveFacet xso = new XmlSchemaMaxInclusiveFacet();
      reader.MoveToElement();
      if (reader.NamespaceURI != "http://www.w3.org/2001/XMLSchema" || reader.LocalName != "maxInclusive")
      {
        XmlSchemaObject.error(h, "Should not happen :1: XmlSchemaMaxInclusiveFacet.Read, name=" + reader.Name, (Exception) null);
        reader.Skip();
        return (XmlSchemaMaxInclusiveFacet) null;
      }
      ...
      while (reader.MoveToNextAttribute())
      {
        ...
        else if (reader.Name == "fixed")
        {
          ...
          XmlSchemaObject.error(h, reader.Name + " is not a valid attribute for maxInclusive", (Exception) null);
        else
      ...
      while (reader.ReadNextElement())
      {
        if (reader.NodeType == XmlNodeType.EndElement)
        {
          ...
          {
            XmlSchemaObject.error(h, "Should not happen :2: XmlSchemaMaxInclusiveFacet.Read, name=" + reader.Name, (Exception) null);
            break;
          }
          break;
        }
