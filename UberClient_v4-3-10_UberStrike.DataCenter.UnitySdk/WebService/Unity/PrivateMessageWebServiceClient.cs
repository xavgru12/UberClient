  ...
  public static class PrivateMessageWebServiceClient
  {
      ...
      Action<Exception> handler)
    {
      using (MemoryStream bytes = new MemoryStream())
      {
        ...
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IPrivateMessageWebServiceContract", "UberStrike.DataCenter.WebService.CWS.PrivateMessageWebServiceContract.svc", "GetAllMessageThreadsForUser_1", bytes.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
      ...
      Action<Exception> handler)
    {
      using (MemoryStream bytes = new MemoryStream())
      {
        ...
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IPrivateMessageWebServiceContract", "UberStrike.DataCenter.WebService.CWS.PrivateMessageWebServiceContract.svc", "GetAllMessageThreadsForUser_2", bytes.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
          callback(ListProxy<MessageThreadView>.Deserialize((Stream) new MemoryStream(data), new ListProxy<MessageThreadView>.Deserializer<MessageThreadView>(MessageThreadViewProxy.Deserialize)));
      ...
      Action<Exception> handler)
    {
      using (MemoryStream bytes = new MemoryStream())
      {
        ...
        Int32Proxy.Serialize((Stream) bytes, pageNumber);
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IPrivateMessageWebServiceContract", "UberStrike.DataCenter.WebService.CWS.PrivateMessageWebServiceContract.svc", nameof (GetThreadMessages), bytes.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
      ...
      Action<Exception> handler)
    {
      using (MemoryStream bytes = new MemoryStream())
      {
        ...
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IPrivateMessageWebServiceContract", "UberStrike.DataCenter.WebService.CWS.PrivateMessageWebServiceContract.svc", nameof (SendMessage), bytes.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
      ...
      Action<Exception> handler)
    {
      using (MemoryStream bytes = new MemoryStream())
      {
        ...
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IPrivateMessageWebServiceContract", "UberStrike.DataCenter.WebService.CWS.PrivateMessageWebServiceContract.svc", nameof (GetMessageWithId), bytes.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
          callback(PrivateMessageViewProxy.Deserialize((Stream) new MemoryStream(data)));
      ...
      Action<Exception> handler)
    {
      using (MemoryStream bytes = new MemoryStream())
      {
        Int32Proxy.Serialize((Stream) bytes, threadViewerCmid);
        Int32Proxy.Serialize((Stream) bytes, otherCmid);
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IPrivateMessageWebServiceContract", "UberStrike.DataCenter.WebService.CWS.PrivateMessageWebServiceContract.svc", nameof (MarkThreadAsRead), bytes.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
          callback();
      ...
      Action<Exception> handler)
    {
      using (MemoryStream bytes = new MemoryStream())
      {
        Int32Proxy.Serialize((Stream) bytes, threadViewerCmid);
        Int32Proxy.Serialize((Stream) bytes, otherCmid);
        return MonoInstance.Mono.StartCoroutine(SoapClient.MakeRequest("IPrivateMessageWebServiceContract", "UberStrike.DataCenter.WebService.CWS.PrivateMessageWebServiceContract.svc", nameof (DeleteThread), bytes.ToArray(), (Action<byte[]>) (data =>
        {
          if (callback == null)
            return;
          callback();
