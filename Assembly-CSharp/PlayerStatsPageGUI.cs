...
internal class PlayerStatsPageGUI : PageGUI
{
	...
	{
		float height = Mathf.Min(_playerListGui.Height, rect.height - 402f) - 2f;
		float num = Mathf.Min(_playerListGui.Height, rect.height - 402f);
		...
		_playerDetailGui.Draw(new Rect(2f, num + 2f, 200f, 200f));
		DrawStats(new Rect(202f, num + 2f, rect.width - 200f - 4f, 200f));
		DrawRewards(new Rect(2f, num + 202f, rect.width - 4f, 200f));
		GUI.EndGroup();
	}
