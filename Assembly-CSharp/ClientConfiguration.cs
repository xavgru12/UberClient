...
public class ClientConfiguration
{
	...
	public string ItemAssetBundlePath
	{
		get;
		set;
	}

	public string MapAssetBundlePath
	{
		get;
		set;
	}
	...
	public string ContentRouterBaseUrl
	{
		get;
		set;
	}
	...
	public string CmuneBootstrapUrl
	{
		get;
		set;
	}
	...
	public string PaymentBundleUrl
	{
		get;
		set;
	}
