...
public class SoundSimulator
{
	...
	public void Update()
	{
		...
		bool flag = (character.State.MovementState & (MoveStates.Grounded | MoveStates.Wading | MoveStates.Swimming | MoveStates.Diving)) != 0;
		bool flag2 = (character.State.Is(MoveStates.Diving) && character.State.KeyState != 0) || (character.State.KeyState & KeyState.Walking) != 0;
