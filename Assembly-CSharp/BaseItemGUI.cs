...
public abstract class BaseItemGUI : IShopItemGUI
{
	...
	protected IBaseItemDetailGUI DetailGUI
	{
		get;
		private set;
	}
	...
	protected void DrawLevelRequirement()
	{
		if (Item.View != null)
		{
			GUI.Label(new Rect(240f, 26f, 60f, 24f), "Lv " + Item.View.LevelLock.ToString(), BlueStonez.label_interparkbold_11pt_left);
		}
	}
	...
	protected void DrawPrice(Rect rect, ItemPrice points, ItemPrice credits)
	{
		...
		if (points != null)
		{
			...
			float num2 = num;
			Vector2 vector = BlueStonez.label_interparkmed_11pt_left.CalcSize(new GUIContent(text));
			num = num2 + (40f + vector.x);
		}
		if (credits != null)
		{
