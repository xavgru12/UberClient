...
{
	public static Texture2D Achievement1MostValuablePlayer
	{
		get;
		private set;
	}

	public static Texture2D Achievement2MostAggressive
	{
		get;
		private set;
	}

	public static Texture2D Achievement3SharpestShooter
	{
		get;
		private set;
	}

	public static Texture2D Achievement4TriggerHappy
	{
		get;
		private set;
	}

	public static Texture2D Achievement5HardestHitter
	{
		get;
		private set;
	}

	public static Texture2D Achievement6CostEffective
	{
		get;
		private set;
	}

	public static Texture2D AchievementDefault
	{
		get;
		private set;
	}

	public static Texture2D RecommendationGear
	{
		get;
		private set;
	}

	public static Texture2D RecommendationMostEfficientWeapon
	{
		get;
		private set;
	}

	public static Texture2D RecommendationSale
	{
		get;
		private set;
	}

	public static Texture2D RecommendationWeapon
	{
		get;
		private set;
	}
