...
{
	public static Texture2D QuadpanelButtonFullscreen
	{
		get;
		private set;
	}

	public static Texture2D QuadpanelButtonNormalize
	{
		get;
		private set;
	}

	public static Texture2D QuadpanelButtonModerate
	{
		get;
		private set;
	}

	public static Texture2D QuadpanelButtonSoundoff
	{
		get;
		private set;
	}

	public static Texture2D QuadpanelButtonSoundon
	{
		get;
		private set;
	}

	public static Texture2D QuadpanelButtonReportplayer
	{
		get;
		private set;
	}

	public static Texture2D QuadpanelButtonOptions
	{
		get;
		private set;
	}

	public static Texture2D QuadpanelButtonHelp
	{
		get;
		private set;
	}
	...
	public static Texture2D QuadpanelButtonLogout
	{
		get;
		private set;
	}
