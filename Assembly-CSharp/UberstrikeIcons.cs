...
{
	public static Texture2D Waiting
	{
		get;
		private set;
	}

	public static Texture2D IconXP20x20
	{
		get;
		private set;
	}

	public static Texture2D BlueLevel32
	{
		get;
		private set;
	}

	public static Texture2D LevelUpPopup
	{
		get;
		private set;
	}

	public static Texture2D FacebookCreditsIcon
	{
		get;
		private set;
	}

	public static Texture2D LevelMastered
	{
		get;
		private set;
	}

	public static Texture2D FBScreenshotWatermark
	{
		get;
		private set;
	}

	public static Texture2D Time20x20
	{
		get;
		private set;
	}
