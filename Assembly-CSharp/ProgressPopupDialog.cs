...
public class ProgressPopupDialog : GeneralPopupDialog
{
	...
	public ProgressPopupDialog(string title, string text, Func<float> progress = null)
		: base(title, text)
	{
		_progress = progress;
	}
	...
	{
		GUI.Label(new Rect(17f, 95f, _size.x - 34f, 32f), base.Text, BlueStonez.label_interparkbold_11pt);
		if (_progress != null)
		{
