...
public class InstantMessage
{
	...
	public bool IsNotification => string.IsNullOrEmpty(PlayerName);

	public CommActorInfo Actor
	{
		get;
		private set;
	}
	...
	{
		Height = ((!isMuted) ? (style.CalcHeight(new GUIContent(Text), width) + (float)offset) : 0f);
	}
