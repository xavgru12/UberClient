...
{
	public static Texture2D ChannelPortal16x16
	{
		get;
		private set;
	}

	public static Texture2D ChannelFacebook16x16
	{
		get;
		private set;
	}

	public static Texture2D ChannelWindows16x16
	{
		get;
		private set;
	}

	public static Texture2D ChannelApple16x16
	{
		get;
		private set;
	}

	public static Texture2D ChannelKongregate16x16
	{
		get;
		private set;
	}

	public static Texture2D ChannelAndroid16x16
	{
		get;
		private set;
	}

	public static Texture2D ChannelIos16x16
	{
		get;
		private set;
	}

	public static Texture2D PresenceOffline
	{
		get;
		private set;
	}

	public static Texture2D PresenceOnline
	{
		get;
		private set;
	}

	public static Texture2D PresencePlaying
	{
		get;
		private set;
	}

	public static Texture2D NewInboxMessage
	{
		get;
		private set;
	}

	public static Texture2D TagLightningBolt
	{
		get;
		private set;
	}

	public static Texture2D SkullCrossbonesIcon
	{
		get;
		private set;
	}

	public static Texture2D ChannelSteam16x16
	{
		get;
		private set;
	}
