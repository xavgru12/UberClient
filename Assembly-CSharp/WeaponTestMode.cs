...
public class WeaponTestMode : FpsGameMode
{
  ...
  [DebuggerHidden]
  private IEnumerator StartDecreasingHealthAndArmor() => (IEnumerator) new WeaponTestMode.\u003CStartDecreasingHealthAndArmor\u003Ec__Iterator35()
  {
    \u003C\u003Ef__this = this
  };

  [DebuggerHidden]
  private IEnumerator SimulateGameFrameUpdate() => (IEnumerator) new WeaponTestMode.\u003CSimulateGameFrameUpdate\u003Ec__Iterator36()
  {
    \u003C\u003Ef__this = this
  };
}
