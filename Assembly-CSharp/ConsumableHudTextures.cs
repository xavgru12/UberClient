...
{
	public static Texture2D TooltipDown
	{
		get;
		private set;
	}

	public static Texture2D TooltipLeft
	{
		get;
		private set;
	}

	public static Texture2D TooltipRight
	{
		get;
		private set;
	}

	public static Texture2D TooltipUp
	{
		get;
		private set;
	}

	public static Texture2D AmmoBlue
	{
		get;
		private set;
	}

	public static Texture2D AmmoRed
	{
		get;
		private set;
	}

	public static Texture2D ArmorBlue
	{
		get;
		private set;
	}

	public static Texture2D ArmorRed
	{
		get;
		private set;
	}

	public static Texture2D HealthBlue
	{
		get;
		private set;
	}

	public static Texture2D HealthRed
	{
		get;
		private set;
	}

	public static Texture2D OffensiveGrenadeBlue
	{
		get;
		private set;
	}

	public static Texture2D OffensiveGrenadeRed
	{
		get;
		private set;
	}

	public static Texture2D SpringGrenadeBlue
	{
		get;
		private set;
	}

	public static Texture2D SpringGrenadeRed
	{
		get;
		private set;
	}

	public static Texture2D CircleBlue
	{
		get;
		private set;
	}
