...
// Type: UberStrike.Realtime.UnitySdk.PhotonPeerListener
...
namespace UberStrike.Realtime.UnitySdk
{
  public class PhotonPeerListener : IPhotonPeerListener
  {
    ...
    private PhotonPeerListener.ConnectionEventType _lastEventEnqueued = PhotonPeerListener.ConnectionEventType.None;
    ...
    private float _nextPingUpdate = 0.0f;
    ...
    public int Latency => this._peer != null ? Mathf.RoundToInt((float) this._peer.RoundTripTime * 0.5f) : 0;
    ...
    public PeerStateValue PeerState => this._peer != null ? this._peer.PeerState : PeerStateValue.Disconnected;
    ...
    public string PeerInfo
    {
      get
      {
        ...
        if (this._peer == null)
          ...
          peerInfo = this._peer.RoundTripTime.ToString() + "/" + (object) this._peer.RoundTripTimeVariance + ", <" + (object) this._peer.BytesIn + ", >" + (object) this._peer.BytesOut;
        return peerInfo;
      }
    }

    public string PingInfo => this._peer != null ? string.Format("{0} ms/{1} ms", (object) this._peer.RoundTripTime, (object) this._peer.RoundTripTimeVariance) : string.Empty;

    public string DataIOInfo => this._peer != null ? string.Format("{0} kb/{1} kb", (object) Mathf.RoundToInt(ConvertBytes.ToKiloBytes(this._peer.BytesIn)), (object) Mathf.RoundToInt(ConvertBytes.ToKiloBytes(this._peer.BytesOut))) : string.Empty;
    ...
    {
      this._actorId = Application.platform != RuntimePlatform.IPhonePlayer ? new SecureMemory<int>(0, monitorMemory) : new SecureMemory<int>(0, monitorMemory, true);
    ...
    public NetworkSimulationSet SimulationSettings => this._peer.NetworkSimulationSettings;
    ...
    public void OnStatusChanged(StatusCode statusCode)
    {
      ...
      switch (statusCode)
      {
        ...
        case StatusCode.Connect:
          ...
          int serverApplication = (int) this.SendOperationToServerApplication((Action<int, object[]>) null, (byte) 1, (object) (byte) 1, (object) ApiVersion.Current);
          if (!CmuneNetworkState.DebugMessaging)
            break;
