...
// Type: UberStrike.Realtime.UnitySdk.DefaultByteConverter
...
namespace UberStrike.Realtime.UnitySdk
{
  public class DefaultByteConverter : IByteConverter
  {
    ...
    public virtual byte GetCmuneDataType(System.Type o)
    {
      ...
      if (o == typeof (Vector3))
        return 30;
      if (o == typeof (Quaternion))
        return 31;
      if (o == typeof (Color))
        return 32;
      if (o == typeof (AssetType))
        return 43;
      if (o == typeof (SyncObject))
        return 48;
      if (o == typeof (CommActorInfo))
        return 46;
      if (o == typeof (NetworkPackage))
        return 44;
      if (o == typeof (RoomMetaData))
        return 40;
      if (o == typeof (CmuneTransform))
        return 42;
      if (o == typeof (CmuneRoomID))
        return 45;
      if (o == typeof (ServerLoadData))
        return 47;
      if (o.IsArray)
      {
        if (o.GetElementType() == typeof (byte))
          return 15;
        if (o.GetElementType() == typeof (int))
          return 20;
        if (o.GetElementType() == typeof (short))
          return 18;
        if (o.GetElementType() == typeof (float))
          return 24;
        if (o.GetElementType() == typeof (string))
          return 26;
        if (o.GetElementType() == typeof (SyncObject))
          return 53;
        if (o.GetElementType() == typeof (CmuneRoomID))
          return 51;
        if (o.GetElementType() == typeof (Quaternion))
          return 36;
        return o.GetElementType() == typeof (Vector3) ? (byte) 35 : (byte) 0;
      }
      if (!o.IsGenericType)
        return 0;
