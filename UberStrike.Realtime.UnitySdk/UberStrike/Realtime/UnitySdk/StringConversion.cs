...
// Type: UberStrike.Realtime.UnitySdk.StringConversion
...
namespace UberStrike.Realtime.UnitySdk
{
  public class StringConversion
  {
    ...
    public static string Replace(string expr, string find, string repl) => string.Equals(expr, find, StringComparison.CurrentCultureIgnoreCase) ? repl : expr;
    ...
    public static string Replace(string expr, string find, string repl, bool bIgnoreCase)
    {
      ...
      {
        if (0 == string.Compare(expr, num, find, 0, length2, bIgnoreCase))
        {
