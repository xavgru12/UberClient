...
namespace Steamworks
{
	public class UTF8Marshaler : ICustomMarshaler
	{
		...
		private static UTF8Marshaler static_instance_free = new UTF8Marshaler(freenativememory: true);

		private static UTF8Marshaler static_instance = new UTF8Marshaler(freenativememory: false);
		...
		{
			if (cookie != null && cookie == "DoNotFree")
			{
