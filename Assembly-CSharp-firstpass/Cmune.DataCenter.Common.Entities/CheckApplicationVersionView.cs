...
namespace Cmune.DataCenter.Common.Entities
{
	...
	{
		public ApplicationView ClientVersion
		{
			get;
			set;
		}

		public ApplicationView CurrentVersion
		{
			get;
			set;
		}
		...
		{
			return "[CheckApplicationVersionView: [ClientVersion: " + ClientVersion?.ToString() + "][CurrentVersion: " + CurrentVersion?.ToString() + "]]";
		}
	}
}
