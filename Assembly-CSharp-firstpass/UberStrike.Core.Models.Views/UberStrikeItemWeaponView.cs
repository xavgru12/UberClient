...
namespace UberStrike.Core.Models.Views
{
	...
	public class UberStrikeItemWeaponView : BaseUberStrikeItemView
	{
		...
		public int DamageKnockback
		{
			get
			{
				return _damageKnockback;
			}
			set
			{
				_damageKnockback = value;
			}
		}
		...
		public int AccuracySpread
		{
			get
			{
				return _accuracySpread;
			}
			set
			{
				_accuracySpread = value;
			}
		}
		...
		public int RecoilKickback
		{
			get
			{
				return _recoilKickback;
			}
			set
			{
				_recoilKickback = value;
			}
		}
		...
		public int MissileTimeToDetonate
		{
			get
			{
				return _missileTimeToDetonate;
			}
			set
			{
				_missileTimeToDetonate = value;
			}
		}
		...
		public int MissileForceImpulse
		{
			get
			{
				return _missileForceImpulse;
			}
			set
			{
				_missileForceImpulse = value;
			}
		}
		...
		public int MissileBounciness
		{
			get
			{
				return _missileBounciness;
			}
			set
			{
				_missileBounciness = value;
			}
		}
		...
		public int RecoilMovement
		{
			get
			{
				return _recoilMovement;
			}
			set
			{
				_recoilMovement = value;
			}
		}
		...
		public int SecondaryActionReticle
		{
			get
			{
				return _secondaryActionReticle;
			}
			set
			{
				_secondaryActionReticle = value;
			}
		}
		...
		public int WeaponSecondaryAction
		{
			get
			{
				return _weaponSecondaryAction;
			}
			set
			{
				_weaponSecondaryAction = value;
			}
		}
		...
		public float DamagePerSecond => (RateOfFire != 0) ? (DamagePerProjectile * ProjectilesPerShot / RateOfFire) : 0;
		...
		public int DefaultZoomMultiplier
		{
			get
			{
				return _defaultZoomMultiplier;
			}
			set
			{
				_defaultZoomMultiplier = value;
			}
		}
		...
		public int MinZoomMultiplier
		{
			get
			{
				return _minZoomMultiplier;
			}
			set
			{
				_minZoomMultiplier = value;
			}
		}
		...
		public int MaxZoomMultiplier
		{
			get
			{
				return _maxZoomMultiplier;
			}
			set
			{
				_maxZoomMultiplier = value;
			}
		}
	}
}
