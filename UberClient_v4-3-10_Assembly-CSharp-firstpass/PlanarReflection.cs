...
public class PlanarReflection : MonoBehaviour
{
  ...
  private void RenderReflectionFor(Camera cam, Camera reflectCamera)
  {
    ...
    reflectCamera.transform.eulerAngles = new Vector3(0.0f - eulerAngles1.x, eulerAngles1.y, eulerAngles1.z);
    reflectCamera.transform.position = cam.transform.position;
    Vector3 position1 = transform.transform.position;
    Vector3 position2 = transform.position;
    position1.y = position2.y;
    Vector3 up = transform.transform.up;
    float w = 0.0f - Vector3.Dot(up, position1) - this.clipPlaneOffset;
    ...
    Vector4 clipPlane = this.CameraSpacePlane(reflectCamera, position1, up, 1f);
    Matrix4x4 projectionMatrix = cam.projectionMatrix;
    Matrix4x4 matrix4x4 = reflectCamera.projectionMatrix = PlanarReflection.CalculateObliqueMatrix(projectionMatrix, clipPlane);
    reflectCamera.transform.position = vector3;
    Vector3 eulerAngles2 = cam.transform.eulerAngles;
    reflectCamera.transform.eulerAngles = new Vector3(0.0f - eulerAngles2.x, eulerAngles2.y, eulerAngles2.z);
