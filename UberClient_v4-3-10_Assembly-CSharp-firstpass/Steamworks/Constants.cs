...
namespace Steamworks
{
  public static class Constants
  {
    ...
    public const ulong k_GIDNil = 18446744073709551615;
    public const ulong k_TxnIDNil = 18446744073709551615;
    public const ulong k_TxnIDUnknown = 0;
    public const uint k_uPackageIdFreeSub = 0;
    public const uint k_uPackageIdInvalid = 4294967295;
    public const ulong k_ulAssetClassIdInvalid = 0;
    public const uint k_uPhysicalItemIdInvalid = 0;
    public const uint k_uCellIDInvalid = 4294967295;
    ...
    public const ulong STEAM_RIGHT_TRIGGER_MASK = 1;
    public const ulong STEAM_LEFT_TRIGGER_MASK = 2;
    public const ulong STEAM_RIGHT_BUMPER_MASK = 4;
    public const ulong STEAM_LEFT_BUMPER_MASK = 8;
    public const ulong STEAM_BUTTON_0_MASK = 16;
    public const ulong STEAM_BUTTON_1_MASK = 32;
    public const ulong STEAM_BUTTON_2_MASK = 64;
    public const ulong STEAM_BUTTON_3_MASK = 128;
    public const ulong STEAM_TOUCH_0_MASK = 256;
    public const ulong STEAM_TOUCH_1_MASK = 512;
    public const ulong STEAM_TOUCH_2_MASK = 1024;
    public const ulong STEAM_TOUCH_3_MASK = 2048;
    public const ulong STEAM_BUTTON_MENU_MASK = 4096;
    public const ulong STEAM_BUTTON_STEAM_MASK = 8192;
    public const ulong STEAM_BUTTON_ESCAPE_MASK = 16384;
    public const ulong STEAM_BUTTON_BACK_LEFT_MASK = 32768;
    public const ulong STEAM_BUTTON_BACK_RIGHT_MASK = 65536;
    public const ulong STEAM_BUTTON_LEFTPAD_CLICKED_MASK = 131072;
    public const ulong STEAM_BUTTON_RIGHTPAD_CLICKED_MASK = 262144;
    public const ulong STEAM_LEFTPAD_FINGERDOWN_MASK = 524288;
    public const ulong STEAM_RIGHTPAD_FINGERDOWN_MASK = 1048576;
