...
namespace Steamworks
{
  public static class SteamFriends
  {
      ...
      out CSteamID psteamidChatter)
    {
      ...
      int clanChatMessage = NativeMethods.ISteamFriends_GetClanChatMessage(steamIDClanChat, iMessage, num, cchTextMax, out peChatEntryType, out psteamidChatter);
      prgchText = clanChatMessage == 0 ? (string) null : InteropHelp.PtrToStringUTF8(num);
      ...
      out EChatEntryType peChatEntryType)
    {
      ...
      int friendMessage = NativeMethods.ISteamFriends_GetFriendMessage(steamIDFriend, iMessageID, num, cubData, out peChatEntryType);
      pvData = friendMessage == 0 ? (string) null : InteropHelp.PtrToStringUTF8(num);
      Marshal.FreeHGlobal(num);
