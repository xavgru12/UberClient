...
namespace Steamworks
{
  public static class SteamRemoteStorage
  {
      ...
      out CSteamID pSteamIDOwner)
    {
      ...
      ppchName = !ugcDetails ? (string) null : InteropHelp.PtrToStringUTF8(ppchName1);
      return ugcDetails;
    }
    ...
    {
      InteropHelp.TestIfAvailableClient();
      return (SteamAPICall_t) NativeMethods.ISteamRemoteStorage_PublishWorkshopFile(pchFile, pchPreviewFile, nConsumerAppId, pchTitle, pchDescription, eVisibility, (IntPtr) new InteropHelp.SteamParamStringArray(pTags), eWorkshopFileType);
    }
    ...
    {
      InteropHelp.TestIfAvailableClient();
      return (SteamAPICall_t) NativeMethods.ISteamRemoteStorage_PublishVideo(eVideoProvider, pchVideoAccount, pchVideoIdentifier, pchPreviewFile, nConsumerAppId, pchTitle, pchDescription, eVisibility, (IntPtr) new InteropHelp.SteamParamStringArray(pTags));
    }
