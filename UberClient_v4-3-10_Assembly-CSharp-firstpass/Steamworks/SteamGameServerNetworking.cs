...
// Type: Steamworks.SteamGameServerNetworking
...
namespace Steamworks
{
  public static class SteamGameServerNetworking
  {
    ...
    public static SNetListenSocket_t CreateListenSocket(
      int nVirtualP2PPort,
      uint nIP,
      ushort nPort,
    ...
    public static SNetSocket_t CreateP2PConnectionSocket(
    ...
    public static bool SendDataOnSocket(
    ...
    public static bool RetrieveDataFromSocket(
      SNetSocket_t hSocket,
      IntPtr pubDest,
      uint cubDest,
      out uint pcubMsgSize)
    ...
    public static bool GetSocketInfo(
      SNetSocket_t hSocket,
      out CSteamID pSteamIDRemote,
    ...
    public static bool GetListenSocketInfo(
      SNetListenSocket_t hListenSocket,
      out uint pnIP,
      out ushort pnPort)
    {
