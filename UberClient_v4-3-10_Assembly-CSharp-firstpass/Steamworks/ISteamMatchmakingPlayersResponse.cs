...
namespace Steamworks
{
  public class ISteamMatchmakingPlayersResponse
  {
    ...
    private void InternalOnAddPlayerToList(string pchName, int nScore, float flTimePlayed) => this.m_AddPlayerToList(pchName, nScore, flTimePlayed);

    private void InternalOnPlayersFailedToRespond() => this.m_PlayersFailedToRespond();

    private void InternalOnPlayersRefreshComplete() => this.m_PlayersRefreshComplete();
