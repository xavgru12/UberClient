...
public class GlowEffect : MonoBehaviour
{
  ...
  public void FourTapCone(RenderTexture source, RenderTexture dest, int iteration)
  {
    ...
    Graphics.BlitMultiTap((Texture) source, dest, this.blurMaterial, new Vector2(num, num), new Vector2(0.0f - num, num), new Vector2(num, 0.0f - num), new Vector2(0.0f - num, 0.0f - num));
  }
