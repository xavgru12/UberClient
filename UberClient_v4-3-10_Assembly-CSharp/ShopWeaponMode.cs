...
public class ShopWeaponMode : FpsGameMode
{
  ...
  [DebuggerHidden]
  private IEnumerator StartDecreasingHealthAndArmor() => (IEnumerator) new ShopWeaponMode.\u003CStartDecreasingHealthAndArmor\u003Ec__Iterator22()
  {
    \u003C\u003Ef__this = this
  };

  [DebuggerHidden]
  private IEnumerator SimulateGameFrameUpdate() => (IEnumerator) new ShopWeaponMode.\u003CSimulateGameFrameUpdate\u003Ec__Iterator23()
  {
    \u003C\u003Ef__this = this
  };
}
