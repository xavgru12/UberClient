...
namespace Cmune.DataCenter.Common.Entities
{
  public class ItemView
  {
    ...
    protected ItemView(ItemView itemView)
    {
      ...
      this.CustomProperties = itemView.CustomProperties != null ? new Dictionary<string, string>((IDictionary<string, string>) itemView.CustomProperties) : new Dictionary<string, string>();
    }
